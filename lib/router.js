...
var attachPageViewTrackingOption = function(options) {
    ...
    options.onRun = function() {
        window.ga && window.ga("send", "pageview", this.url);

        return callEventHandlerOrNext.call(this, onRun, arguments);
    };
};
...
var attachExperiment = function(routeName, options) {
    ...
    options.onBeforeAction = (function() {
        ...
        return function() {
            ...
            return callEventHandlerOrNext.call(this, onBeforeAction, arguments);
        };
    }());
